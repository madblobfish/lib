...
HELP_TEXT << '      e.g.: (state == seen && year < 1992) || title like Gintama && genres all action,time_travel'
...
HELP_TEXT << '  --hide-other do not show choices of others in the interactive tui'
