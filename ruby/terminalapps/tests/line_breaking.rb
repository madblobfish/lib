...
class LineBreaking < TerminalGame
  def initialize(size_x=13, size_y=33, text=nil, columns=1)
    ...
    @text = text || (
      'Sixty-Four comes asking for bread. She folded her handkerchief neatly. ' +
      'The underground bunker was filled with chips and candy. The bees decided to have a mutiny against their queen. There were three sphered rocks congregating in a cubed room. Best friends are like old tomatoes and shoelaces. Baby wipes are made of chocolate stardust. The rain pelted the windshield as the darkness engulfed us.' +
      "\n\n" +
